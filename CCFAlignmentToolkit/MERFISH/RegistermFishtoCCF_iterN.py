...
outDirBase=f'/Users/min/Documents/ResearchResults/AllenInstitute/merFish/RegPrelimDefNNLandmarksIterN_SynOnly_{outname}/'

os.makedirs(outDirBase,exist_ok=True)
    
LabelsMax = [73, 76]
LabelsMin = [72, 75]
LabelsReplFrom = [72, 75]
LabelsReplTo = [73, 76]
...
for iter in range(numLabels):
        ...
        for i in range(Nslc):
            ...
            shutil.move(registration['invtransforms'][0],f'{outDirIter}/slcTrans/{outname}_invDef_slc{i}.nii.gz')
