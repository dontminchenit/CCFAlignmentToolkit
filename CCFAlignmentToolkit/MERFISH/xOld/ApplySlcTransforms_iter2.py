...
inputDir='/Users/min/Documents/ResearchResults/AllenInstitute/merFish/Data/Mouse3_v2/warpedImages'
baseDir='/Users/min/Documents/ResearchResults/AllenInstitute/merFish/RegPrelimDefNNLandmarks76_SynOnly_mouse3_v2/'
baseName='mouse3_v2'
interpType='linear'
...
outDir=f'{inputDir}/warpedImages76/'
...
for input in inputFiles:
        ...
        for i in range(Nslc):
            ...
            #Apply transforms
            Tlist=[f'{slcDir}{baseName}_fwdDef_slc{i}.nii.gz']
